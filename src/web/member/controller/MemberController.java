...
public class MemberController {
	@Autowired
	private MemberService memberService;//變數名稱需與Hibernate步驟7中交給Spring-Core管理的物件名稱(黑底)相同
	...
	public String findMemberByKey(Model model, Integer id) {//6.2宣告請求參數註10
		...
		model.addAttribute("message", "findMemberByKey");//Model物件類似Servlet裡的HttpServletRequest物件, 用來儲存屬性物件
